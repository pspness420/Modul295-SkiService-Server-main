...
namespace SkiServiceManagement.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(LoginRequest request)
        {
            ...
            var filter = Builders<Benutzer>.Filter.Eq("Benutzername", user.Benutzername);
        ...
        public IActionResult Logout([FromBody] string refreshToken)
        {
            ...
            _context.Benutzer.ReplaceOne(Builders<Benutzer>.Filter.Eq("Benutzername", user.Benutzername), user);
